...
/**
 * This class contains common utilities and methods for the mod. Everything in this class must
 * be safe to access or class load from any Java environment.
 */
public final class Utils {
    ...
    /**
     * Checks if the locked file {@link #LOCK} has been created. If this returns true the mod
     * should completely disable itself.
     * 
    ...
    /**
     * Checks if the JVM is 64bit. This is done by checking various properties for the 64x
     * flag.
     * 
    ...
    public static void createWarning (String message, String title, String url, String readMore, String ignore, String stop, Path file) {
        ...
        try {
            ...
            final ProcessBuilder builder = new ProcessBuilder(System.getProperty("java.home") + "/bin/java", "-jar", file.toString(), message, title, url, readMore, ignore, stop);
            builder.inheritIO();
            builder.start();
        }
