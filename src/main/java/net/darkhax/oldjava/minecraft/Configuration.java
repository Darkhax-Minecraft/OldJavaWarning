...
public class Configuration {
    ...
    public Configuration () {
        ...
        checkJavaVersion = builder.define("enabled", true);
        
        builder.comment("What is the minimum version of Java to look for?");
        minJavaVersion = builder.define("minVersion", "1.8.0_162");
        builder.pop();
        ...
        check32Bit = builder.define("warn32Bit", true);       
        builder.pop();
        ...
        checkMinMemory = builder.define("warnLowMemory", true);
